...
def update():
    ...
    if request.method == "POST":
        ...
        return render_template("update.html", installed=installed, desired=desired, actions=actions, confirm=True, device=device, devices=DEVICES, branch=branch, commit_id=commit_id)
    return render_template("update.html", installed=installed, desired={}, actions={}, confirm=False, device=device, devices=DEVICES, branch="manual", commit_id="")
